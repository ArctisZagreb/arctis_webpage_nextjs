  ...
  return (
    <section className={styles["content"]}>
      <p className={styles["paragraph"]}>
        ...
        the depth and breadth of experience necessary turn vision into reality.
      </p>
      <p className={styles["paragraph"]}>
        ...
        customers with the project management and project coordination services
      ...
      <p className={styles["paragraph"]}>
        ...
        and leveraging industry best practices, we @Arctis focus on delivering a
        faster project deployment and a reliable return on your technology
        investment.
      </p>
      <p className={styles["paragraph"]}>
      ...
      <p className={styles["paragraph"]}>
        ...
        high-impact releases that enable delivering a series of wins over time.
      </p>
      <p className={styles["paragraph"]}>
      ...
      <p className={styles["paragraph"]}>
        ...
        practices when adaptability and agility are required. Together with our
        customers, we have established project processes that are based on best
        practice standards, while simultaneously leaving plenty of room for
        tailoring and customization, based on individual organisations
        specifications.
      </p>
      <div className={styles["parallax-image"]}>
        <Image
          src="/assets/images/decorative/paragraph.png"
